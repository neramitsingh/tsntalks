...
from .youtube import channel_stats_source, fetch_flat_catalogue, parse_flat_catalogue, video_stats_source
...
def cmd_collect(args) -> int:
    ...
    run = HourlyRun(Zernio(st.zernio_api_key), Supa(st.supabase_url, st.supabase_service_key), now=now, daily=daily,
                    ...
                    channel_stats=channel_stats_source(st.youtube_api_key, st.youtube_channel_url))
    result = run.execute()
